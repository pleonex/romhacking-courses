...
% Hide this slide, it's to complex to explain with no knowledge
\begin{frame}<handout:0|beamer:0>{Números hexadecimales}
    ...
    \end{itemize}
    \visible<2->{\includegraphics[width=\textwidth]{imgs/bitop.png}}
\end{frame}
