...
\begin{frame}{Mis proyectos}
    ...
    \begin{column}[T]{0.65\textwidth}
        ...
        \includegraphics[width=0.5\textwidth]{ninokuni_preview.jpg}
    \end{column}
    \end{columns}
...
\begin{frame}{Érase una vez\ldots}
    \centering \includegraphics[width=0.65\textwidth]{bigbang.png}
\end{frame}
...
\begin{frame}{La parte cruda de los archivos}
    \includefigure{Imagen vista con editor hexadecimal HxD}{hexview.png}{0.6}
\end{frame}
