...
\begin{frame}{Mis proyectos}
    ...
    \begin{column}[T]{0.65\textwidth}
        ...
        \visible<2->{\includegraphics[width=0.5\textwidth]{ninokuni_preview.jpg}}
    \end{column}
    \end{columns}
...
\begin{frame}{Érase una vez\ldots}
    \visible<2->{\centering \includegraphics[width=0.65\textwidth]{bigbang.png}}
\end{frame}
...
\begin{frame}{La parte cruda de los archivos}
    \includefigure{BMP visto con editor hexadecimal HxD}{hexview.png}{0.6}
\end{frame}
...
\begin{frame}{Especificaciones (BMP)}
    ...
    \begin{column}[T]{0.7\textwidth}
        ...
        {\includegraphics[width=\textwidth]{hexview.png}};
...
\begin{frame}{¿Qué hay dentro de un juego?}
    ...
    \begin{column}{0.65\textwidth}
        ¿ \includegraphics{gamefile.png}~?
        \visible<2->{\textrightarrow}
    \end{column}
    \hfill
    \begin{column}{0.35\textwidth}
        \visible<2->{\includegraphics[width=\textwidth]{game_desmume.png}}
    \end{column}
    \end{columns}
\end{frame}

\begin{frame}{La parte cruda de un juego}
    \includegraphics[width=\textwidth]{game_hex.png}
\end{frame}

\begin{frame}{¿Y ahora? ¿Y la especificación?}
    \includegraphics[width=\textwidth]{left_blank.png}
\end{frame}

\begin{frame}{ROM Hacking}
    \includegraphics[width=\textwidth]{this_is_romhacking.png}
\end{frame}
...
\begin{frame}{ROM Hacking}
    ...
    \begin{column}{0.65\textwidth}
        \centering
        \visible<2->{\includegraphics[width=0.45\textwidth]{ninokuni_preview.jpg}}
        \visible<3->{\includegraphics[width=0.45\textwidth]{mods_preview.jpg}}
        \visible<4->{\includegraphics[width=0.4\textwidth]{spriters.png}}
        \visible<5->{\includegraphics[width=0.8\textwidth]{tinke_preview.png}}
    \end{column}
    \end{columns}
\end{frame}
