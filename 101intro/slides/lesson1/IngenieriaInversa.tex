...
\begin{frame}{Tinke}
    ...
    \only<1>{\includefigure{Tinke}{tinke.png}{1}}
    \only<2>{\includefigure{Interfaz}{tinke_preview.png}{1}}
\end{frame}
...
\begin{frame}{Tipos de ficheros}
    ...
    \begin{column}{0.5\textwidth}
        \begin{itemize}
            \item Paleta \includegraphics{palette.png}
            \item Tiles \includegraphics{picture.png}
            \item Map \includegraphics{picture_link.png}
            \item Sprites \includegraphics{pictures.png}
            \item Animaciones \includegraphics{picture_go.png}
            \item Modelos 3D \includegraphics{map.png}
            \item Texturas \includegraphics{image.png}
            \item Imagen completa \includegraphics{photo.png}
        \end{itemize}
    \end{column}
    \hfill
    \begin{column}{0.5\textwidth}
        \begin{itemize}
            \item Texto \includegraphics{page_white_text.png}
            \item Tipografía \includegraphics{font.png}
            \item Scripts \includegraphics{script.png}
            \item Archivo comprimido \includegraphics{compress.png}
            \item Paquete \includegraphics{package.png}
            \item Música \includegraphics{music.png}
            \item Vídeo \includegraphics{film.png}
        \end{itemize}
    \end{column}
    \end{columns}
\end{frame}
